...
* **Radio Q&A With the Full Race Picture:** Ask anything over push-to-talk. The engineer remembers the conversation for the session and answers from live data for every car: gaps and whether they are closing, rivals' tyres and stops, tyre wear per lap and laps to the limit, fuel burn against target, pit window, weather for the current session, and the calls it already made.
