...
// 1. Time Delta Chart Subcomponent
interface DeltaChartProps extends CommonChartProps {
  hasDeltaData: boolean;
  maxGapA: number;
  maxGapB: number;
}

const DeltaChart = React.memo<DeltaChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 2. Speed Chart Subcomponent
interface SpeedChartProps extends CommonChartProps {
  maxGapA: number;
  maxGapB: number;
}

const SpeedChart = React.memo<SpeedChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 3. Throttle Chart Subcomponent
const ThrottleChart = React.memo<CommonChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 4. Brake Chart Subcomponent
const BrakeChart = React.memo<CommonChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 5. Gear Selection Chart Subcomponent
const GearChart = React.memo<CommonChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 6. Steering Angle Chart Subcomponent
const SteeringChart = React.memo<CommonChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 7. ERS Battery Chart Subcomponent
interface ErsBatteryChartProps extends CommonChartProps {
  isErsRestrictedA: boolean;
  isErsRestrictedB: boolean;
}

const ErsBatteryChart = React.memo<ErsBatteryChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 8. ERS Deploy Mode Chart Subcomponent
interface ErsDeployModeChartProps extends CommonChartProps {
  isErsRestrictedA: boolean;
  isErsRestrictedB: boolean;
  formatA?: number | null;
  formatB?: number | null;
...
const ErsDeployModeChart = React.memo<ErsDeployModeChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
...
// 9. Active Aero & Boost Chart Subcomponent (2026 Telemetry)
const ActiveAeroChart = React.memo<CommonChartProps>(({
  chartData,
  nameA,
  nameB,
  sector1Distance,
